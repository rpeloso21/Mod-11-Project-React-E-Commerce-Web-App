        ...
        <Navbar bg='light' expand='lg'>
            ...
            <Navbar.Collapse id='basic-navbar-nav'>
                <Nav className='mr-auto'>
                    ...
                    <Nav.Link as={NavLink} to={'/add-customer/'} activeclassname='active'>Add Customer</Nav.Link>
                    ...
                    <Nav.Link as={NavLink} to={'/add-order/'} activeclassname='active'>Add Order</Nav.Link>
